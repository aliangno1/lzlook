...
@Service("www.xbiquge.la")
public class XbiqugeLaCrawler implements NovelCrawlerService {
    private final static String source = "www.xbiquge.la";
    private final static String sourceUri = "http://www.xbiquge.la";
